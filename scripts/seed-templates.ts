...
import {
  ...
  saveTheDateSections,
  corporateSections,
} from "@/lib/template-schemas/sections";
...
const templates = [
  // ── Hindu Wedding ─────────────────────────────────────────────────────────
  {
    ...
    category: "hindu",
    tags: ["wedding", "traditional", "hindi", "bengali", "marathi", "punjabi"],
    featured: true,
    order: 1,
    sections: weddingSections(),
    defaultVariantKey: "saffron",
    variants: [
      {
        key: "saffron",
        name: "Saffron & Crimson",
        theme: {
          palette: palette("#FFF8EE", "#FFF0D6", "#C0392B", "#E67E22", "#1A0A00", "#7D5921"),
          fonts: fonts("Fraunces", "Inter", "Dancing Script"),
          customizable: { palette: true, fonts: false },
          animationPreset: "reveal-soft",
        },
        previewImage: "",
      },
      {
        ...
        name: "Turmeric & Jade",
        theme: {
          palette: palette("#FFFFF0", "#F5F0D0", "#1A6B4A", "#D4AC0D", "#0D1B0E", "#4A7C59"),
          fonts: fonts("Fraunces", "Inter", "Dancing Script"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
        previewImage: "",
      },
  ...
  },
  {
    ...
    category: "hindu",
    tags: ["wedding", "modern", "minimal", "luxury"],
    featured: false,
    order: 2,
    sections: weddingSections(),
    defaultVariantKey: "noir",
    variants: [
      {
        key: "noir",
        name: "Ink & Champagne",
        theme: {
          palette: palette("#0E0E0E", "#1A1A1A", "#D4AF37", "#F5ECD7", "#FAFAFA", "#888888"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: false, fonts: false },
  ...
  // ── South Indian Wedding ──────────────────────────────────────────────────
  {
    ...
    tags: ["wedding", "tamil", "telugu", "kannada", "silk", "traditional"],
    featured: true,
    order: 3,
    sections: weddingSections(),
    defaultVariantKey: "purple-gold",
    variants: [
      {
        key: "purple-gold",
        name: "Zari Purple & Gold",
        theme: {
          palette: palette("#F8F4FF", "#EDE5FF", "#5B2D8E", "#B8860B", "#120826", "#7B5EA7"),
          fonts: fonts("Fraunces", "Inter", "Noto Serif"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
        previewImage: "",
      ...
      {
        key: "red-gold",
        name: "Temple Red & Gold",
        theme: {
          palette: palette("#FFF5F5", "#FFE8E8", "#8B0000", "#D4AF37", "#1A0000", "#8B4513"),
          fonts: fonts("Fraunces", "Inter", "Noto Serif"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  },
  {
    ...
    category: "south-indian",
    tags: ["wedding", "kerala", "tamil", "minimal", "floral"],
    featured: false,
    order: 4,
    sections: weddingSections(),
    defaultVariantKey: "ivory-green",
    variants: [
      {
        key: "ivory-green",
        name: "Ivory & Forest Green",
        theme: {
          palette: palette("#FDFAF5", "#F5EDD9", "#1A5C3A", "#D4AC0D", "#1A1208", "#5C8B6E"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Muslim / Nikah ────────────────────────────────────────────────────────
  {
    ...
    category: "muslim",
    tags: ["nikah", "muslim", "islamic", "traditional", "urdu"],
    featured: true,
    order: 5,
    sections: weddingSections(),
    defaultVariantKey: "emerald",
    variants: [
      {
        key: "emerald",
        name: "Emerald & Rose Gold",
        theme: {
          palette: palette("#F2FAF5", "#E0F5EA", "#0D5C3A", "#B76E79", "#071A0E", "#4A8B6A"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  },
  {
    ...
    category: "muslim",
    tags: ["nikah", "muslim", "islamic", "dark", "luxury"],
    featured: false,
    order: 6,
    sections: weddingSections(),
    defaultVariantKey: "midnight",
    variants: [
      {
        key: "midnight",
        name: "Midnight Blue & Silver",
        theme: {
          palette: palette("#F5F7FF", "#E8EDFF", "#0A1C5A", "#C0C0C0", "#050D2A", "#4A5580"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: false },
          animationPreset: "cinematic",
        },
        previewImage: "",
      },
  ...
  // ── Christian Wedding ─────────────────────────────────────────────────────
  {
    ...
    category: "christian",
    tags: ["wedding", "christian", "goa", "kerala", "church", "floral"],
    featured: true,
    order: 7,
    sections: weddingSections(),
    defaultVariantKey: "chapel",
    variants: [
      {
        key: "chapel",
        name: "Ivory & Forest Green",
        theme: {
          palette: palette("#FDFCFA", "#F5F0E8", "#2C5F2E", "#8B6914", "#1A1208", "#6B7C6B"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  },
  {
    ...
    category: "christian",
    tags: ["wedding", "christian", "goa", "beach", "coastal", "summer"],
    featured: false,
    order: 8,
    sections: weddingSections(),
    defaultVariantKey: "coastal",
    variants: [
      {
        key: "coastal",
        name: "Sky Blue & White",
        theme: {
          palette: palette("#F0F8FF", "#E0F0FF", "#1B6CA8", "#D4AC0D", "#0A2A4A", "#5A8FAA"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Sikh ─────────────────────────────────────────────────────────────────
  {
    ...
    category: "sikh",
    tags: ["anand-karaj", "sikh", "punjabi", "golden", "traditional"],
    featured: true,
    order: 9,
    sections: weddingSections(),
    defaultVariantKey: "golden",
    variants: [
      {
        key: "golden",
        name: "Royal Blue & Gold",
        theme: {
          palette: palette("#FFFBF0", "#FFF3D0", "#1A3A6B", "#D4AF37", "#0A1428", "#5A7AAA"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Engagement ────────────────────────────────────────────────────────────
  {
    ...
    category: "engagement",
    tags: ["engagement", "ring-ceremony", "roka", "minimal", "rose"],
    featured: true,
    order: 10,
    sections: engagementSections(),
    defaultVariantKey: "rose",
    variants: [
      {
        key: "rose",
        name: "Dusty Rose & Slate",
        theme: {
          palette: palette("#FFF5F7", "#FFE8EE", "#C2185B", "#D4AF37", "#2A0A14", "#A0607A"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  },
  {
    ...
    category: "engagement",
    tags: ["engagement", "modern", "abstract", "minimal", "bold"],
    featured: false,
    order: 11,
    sections: engagementSections(),
    defaultVariantKey: "indigo",
    variants: [
      {
        key: "indigo",
        name: "Indigo & Terracotta",
        theme: {
          palette: palette("#F5F5FF", "#EBEBFF", "#2D2B8F", "#C4622D", "#0A0A2A", "#7070C0"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "cinematic",
        },
  ...
  // ── Birthday ──────────────────────────────────────────────────────────────
  {
    ...
    category: "birthday",
    tags: ["birthday", "milestone", "celebration", "adult", "bold"],
    featured: true,
    order: 12,
    sections: birthdaySections(),
    defaultVariantKey: "coral",
    variants: [
      {
        key: "coral",
        name: "Coral & Navy",
        theme: {
          palette: palette("#FFF5F2", "#FFE8E0", "#0D2B5E", "#FF6B47", "#080F1F", "#3D6B9E"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
  ...
  },
  {
    ...
    category: "birthday",
    tags: ["birthday", "kids", "pastel", "first-birthday", "playful"],
    featured: false,
    order: 13,
    sections: birthdaySections(),
    defaultVariantKey: "pastel",
    variants: [
      {
        key: "pastel",
        name: "Mint, Lavender & Blush",
        theme: {
          palette: palette("#F5FFFE", "#E8FFF9", "#7B5EA7", "#FF8FAB", "#1A0A2E", "#8B88C0"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "playful",
        },
  ...
  // ── Save the Date ─────────────────────────────────────────────────────────
  {
    ...
    tags: ["save-the-date", "minimal", "elegant", "clean"],
    featured: true,
    order: 14,
    sections: saveTheDateSections(),
    defaultVariantKey: "charcoal",
    variants: [
      {
        key: "charcoal",
        name: "Charcoal & Saffron",
        theme: {
          palette: palette("#FAFAFA", "#F0F0F0", "#1F1F1F", "#E07B00", "#0A0A0A", "#888888"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  },
  {
    ...
    category: "save-the-date",
    tags: ["save-the-date", "botanical", "nature", "outdoor", "floral"],
    featured: false,
    order: 15,
    sections: saveTheDateSections(),
    defaultVariantKey: "botanical",
    variants: [
      {
        key: "botanical",
        name: "Forest & Blush",
        theme: {
          palette: palette("#F5FAF5", "#E8F5E8", "#1A4A1A", "#E8A598", "#071407", "#5A8A5A"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Anniversary ──────────────────────────────────────────────────────────
  {
    ...
    tags: ["anniversary", "silver", "25th", "elegant", "mature"],
    featured: false,
    order: 16,
    sections: engagementSections(),
    defaultVariantKey: "silver",
    variants: [
      {
        key: "silver",
        name: "Silver & Slate",
        theme: {
          palette: palette("#F8F9FA", "#EEEFF2", "#3D4A5C", "#9DA8B7", "#1A1F28", "#6A7A8C"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: false },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Baby Shower ──────────────────────────────────────────────────────────
  {
    ...
    tags: ["baby-shower", "new-baby", "pastel", "soft", "floral"],
    featured: false,
    order: 17,
    sections: engagementSections(),
    defaultVariantKey: "bloom",
    variants: [
      {
        key: "bloom",
        name: "Cloud & Blush",
        theme: {
          palette: palette("#F5F9FF", "#E8F2FF", "#4A7EC0", "#F5A0B0", "#0A1428", "#7AACCF"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "playful",
        },
  ...
  // ── Housewarming ─────────────────────────────────────────────────────────
  {
    ...
    tags: ["housewarming", "griha-pravesh", "home", "warm", "terracotta"],
    featured: false,
    order: 18,
    sections: engagementSections(),
    defaultVariantKey: "terracotta",
    variants: [
      {
        key: "terracotta",
        name: "Terracotta & Sage",
        theme: {
          palette: palette("#FDF8F5", "#F5EDE5", "#B45309", "#4A7C59", "#2A1A0A", "#A0785A"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Mehendi ───────────────────────────────────────────────────────────────
  {
    ...
    category: "hindu",
    tags: ["mehendi", "henna", "pre-wedding", "fun", "vibrant"],
    featured: false,
    order: 19,
    sections: engagementSections(),
    defaultVariantKey: "henna",
    variants: [
      {
        key: "henna",
        name: "Saffron & Deep Green",
        theme: {
          palette: palette("#FFFAEE", "#FFF0CC", "#0D5C3A", "#E07B00", "#0A1E0D", "#5C8B6A"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "playful",
        },
  ...
  // ── Sangeet ───────────────────────────────────────────────────────────────
  {
    ...
    description: "Lights, camera, dhol. Electric pink, midnight black, and gold sequins for the sangeet night. For those who want to party.",
    category: "hindu",
    tags: ["sangeet", "pre-wedding", "party", "dance", "bollywood", "neon"],
    featured: false,
    order: 20,
    sections: engagementSections(),
    defaultVariantKey: "neon",
    variants: [
      {
        key: "neon",
        name: "Electric Pink & Midnight",
        theme: {
          palette: palette("#FFF0FA", "#FFD6F5", "#0A0A14", "#FF1A8C", "#050508", "#CC44AA"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: false },
          animationPreset: "cinematic",
        },
  ...
  // ── Corporate ─────────────────────────────────────────────────────────────
  {
    ...
    category: "corporate",
    tags: ["corporate", "event", "professional", "launch", "conference"],
    featured: false,
    order: 21,
    sections: corporateSections(),
    defaultVariantKey: "slate",
    variants: [
      {
        key: "slate",
        name: "Slate & Cobalt",
        theme: {
          palette: palette("#F8FAFC", "#EEF2F7", "#1E3A5F", "#2563EB", "#0A1520", "#5A7A9A"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "reveal-soft",
        },
  ...
  // ── Festival / Diwali ─────────────────────────────────────────────────────
  {
    ...
    category: "other",
    tags: ["festival", "diwali", "celebration", "lights", "gold", "crimson"],
    featured: false,
    order: 22,
    sections: engagementSections(),
    defaultVariantKey: "diwali",
    variants: [
      {
        key: "diwali",
        name: "Crimson & Gold",
        theme: {
          palette: palette("#FFF5F0", "#FFE8D6", "#8B0000", "#D4AF37", "#1A0000", "#AA4444"),
          fonts: fonts("Fraunces", "Inter"),
          customizable: { palette: true },
          animationPreset: "cinematic",
        },
